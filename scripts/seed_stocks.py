...
EGX_STOCKS = [
    ...
    ("ARCC",   "العربية للإسمنت",                                  "Arab Cement",                             "مواد البناء",           True),
    # ── العقارات ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
    ("TMGH",   "مجموعة طلعت مصطفى القابضة",                      "Talaat Moustafa Group",                   "العقارات",              True),
    ("MASR",   "مدينة مصر للإسكان والتعمير",                     "Madinet Masr",                            "العقارات",              True),
    ("PHDC",   "بالم هيلز للتعمير",                               "Palm Hills Developments",                 "العقارات",              True),
    ("MNHD",   "مدينة نصر للإسكان والتعمير",                     "Madinet Nasr Housing",                    "العقارات",              False),
    ("OCDI",   "السادس من أكتوبر للتنمية والاستثمار (سوديك)",    "SODIC",                                   "العقارات",              True),
    ("ORHD",   "أوراسكوم للتنمية مصر",                           "Orascom Development Egypt",               "العقارات",              True),
    ...
    ("CIRA",   "القاهرة للاستثمار والتنمية العقارية",             "CIRA",                                    "العقارات",              True),
    ...
    ("GIHD",   "الغربية الإسلامية للتنمية العمرانية",             "Gharbia Islamic Housing",                 "العقارات",              False),
    # ── الأدوية والرعاية الصحية ───────────────────────────────────────────────────────────────────────────────────────────────────────
    ("ISPH",   "ابن سينا فارما",                                   "Ibn Sina Pharma",                         "الأدوية",               True),
    ...
    ("RMDA",   "العاشر من رمضان للصناعات الدوائية",               "10th of Ramadan Pharmaceutical",         "الأدوية",               True),
    ...
    ("AMOC",   "الإسكندرية للزيوت المعدنية",                      "Alexandria Mineral Oils Company",         "البتروكيماويات",        True),
    ("SKPC",   "سيدي كرير للبتروكيماويات",                        "Sidi Kerir Petrochemicals",               "البتروكيماويات",        True),
    ("EGAS",   "غاز مصر - إيجاس",                                  "Egypt Gas",                               "الطاقة",                True),
    ("ABUK",   "أبوقير للأسمدة والصناعات الكيماوية",              "Abu Qir Fertilizers",                     "الصناعات الكيماوية",    False),
    ...
    # ── الغذاء والشراب ────────────────────────────────────────────────────────────────────────────────────────────────────────────────
    ("JUFO",   "جهينة للصناعات الغذائية",                         "Juhayna Food Industries",                 "الغذاء والشراب",        True),  # EGX 33
    ("POUL",   "القاهرة للدواجن",                                  "Cairo Poultry",                           "الغذاء والشراب",        False),
    ("DOMT",   "الصناعات الغذائية العربية - دومتي",               "Domty",                                   "الغذاء والشراب",        False),
    ("AJWA",   "اجواء للصناعات الغذائية - مصر",                   "Ajwa Food Industries",                    "الغذاء والشراب",        False),
    ("EFID",   "ايديتا للصناعات الغذائية",                        "Edita Food Industries",                   "الغذاء والشراب",        True),
    ("EAST",   "الشرقية - إيسترن كومباني",                        "Eastern Company",                         "الغذاء والشراب",        False),
    ("OLFI",   "عبور لاند للصناعات الغذائية",                     "Obuorland Food",                          "الغذاء والشراب",        True),
    ("ISMA",   "الاسماعيلية مصر للدواجن",                         "Ismailia Misr Poultry",                   "الغذاء والشراب",        False),
    ("EPCO",   "المصرية للدواجن",                                  "Egyptian Poultry",                        "الغذاء والشراب",        False),
    ("MPCO",   "المنصورة للدواجن",                                 "Mansoura Poultry",                        "الغذاء والشراب",        True),
    ("SNFI",   "سوهاج الوطنية للصناعات الغذائية",                 "Sohag National Food",                     "الغذاء والشراب",        False),
    ("SNFC",   "الشرقية الوطنية للأمن الغذائي",                   "Eastern National Food Security",          "الغذاء والشراب",        False),
    ...
    ("ETEL",   "المصرية للاتصالات",                                "Telecom Egypt",                           "الاتصالات",             True),
    ("EFIH",   "إى فاينانس للاستثمارات المالية والرقمية",          "e-Finance",                               "التكنولوجيا",           True),
    ...
    ("ETRS",   "المصرية لخدمات النقل والتجارة الدولية",            "ETRS",                                    "النقل والخدمات",        True),
    ...
    ("ATQA",   "مصر الوطنية للصلب - عتاقة",                       "Egyptian National Steel - Atqa",          "الصناعات الأساسية",     True),
    ("EGAL",   "مصر للألومنيوم",                                   "Egyptian Aluminum",                       "الصناعات الأساسية",     True),
    ...
    ("MCQE",   "مصر للإسمنت - قنا",                               "Misr Cement Qena",                        "مواد البناء",           True),
    ...
    ("LCSW",   "ليسيكو مصر",                                       "Lecico Egypt",                            "مواد البناء",           True),
    ...
    ("ICFC",   "الدولية للأسمدة والكيماويات",                      "International Co. for Fertilizers",       "الصناعات الكيماوية",    True),
    ("KZPC",   "قفر الزيات للمبيدات والكيماويات",                 "Kafr El Zayat Pesticides",                "الصناعات الكيماوية",    False),
    ("MFPC",   "مصر لإنتاج الأسمدة - موبكو",                      "MOPCO",                                   "الصناعات الكيماوية",    False),
    ...
    ("MTIE",   "إمام جروب للصناعة والتجارة العالمية",              "Imam Group for Industry & Trade",         "الصناعات الهندسية",     True),
    ...
    # ── الصناعات النسيجية ────────────────────────────────────────────────────────────────────────────────────────────────────────────
    ("ORWE",   "النساجون الشرقيون للسجاد",                         "Oriental Weavers",                        "الصناعات النسيجية",     True),
    ("SPIN",   "الإسكندرية للغزل والنسيج",                        "Alexandria Spinning & Weaving",           "الصناعات النسيجية",     False),
    ("ACGC",   "العربية لحليج الأقطان",                            "Arab Cotton Ginning",                     "الصناعات النسيجية",     True),
    ...
    # ── التشييد والبناء ───────────────────────────────────────────────────────────────────────────────────────────────────────────────
    ("ORAS",   "أوراسكوم للإنشاء",                                 "Orascom Construction",                    "التشييد والبناء",       True),
    ...
    ("EFIH",   "إى فاينانس للاستثمارات المالية والرقمية",          "e-Finance for Financial & Digital Inv.",  "المالية",               True),
    ...
    ("RACC",   "راية لخدمات مراكز الاتصالات",                      "Raya Contact Center",                     "التكنولوجيا",           True),
    ...
    ("IFAP",   "الدولية للمحاصيل الزراعية",                         "International Agricultural Products",     "الزراعة",               True),
    ("NEDA",   "شمال الصعيد للتنمية والإنتاج الزراعي",              "North Sohag Development",                 "الزراعة",               False),
    ("KRDI",   "نهر الخير للتنمية والاستثمار الزراعي",              "Nahr El Khair Agricultural",              "الزراعة",               False),
    ("LUTS",   "لوتس للتنمية والاستثمار الزراعي",                   "Lotus Agricultural",                      "الزراعة",               False),
    ("GGRN",   "جو جرين للاستثمار الزراعي والتنمية",               "Go Green Agricultural Investment",        "الزراعة",               False),
